...
console.log("Generating scene (V2)...");
const t0 = Date.now();
...
await writeFile(reportPath, `${JSON.stringify({ version: "0.1", algorithm: "v2", reports }, null, 2)}\n`, "utf8");

console.log(`\nGenerated [V2] in ${elapsed}s: ${scene.paths.length} paths, ${scene.soundObjects.length} sound objects.`);
